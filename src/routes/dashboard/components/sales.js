          ...
          <Legend verticalAlign="top"
            content={(prop) => {
              ...
              return (
                <ul className={ classnames({ [styles.legend]: true, clearfix: true }) }>
                  { payload.map((item, key) => <li key={key}><span className={styles.radiusdot} style={{
            ...
            <Tooltip
              ...
              content={(content) => {
                ...
                return <div className={styls.tooltip}><p className={styles.tiptitle}>{content.label}</p><ul>{list}</ul></div>
              }}
            />
